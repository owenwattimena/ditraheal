...
class PostEfficationQuiz extends StatefulWidget {
  const PostEfficationQuiz({Key? key}) : super(key: key);

  @override
  State<PostEfficationQuiz> createState() => _PostEfficationQuizState();
}

class _PostEfficationQuizState extends State<PostEfficationQuiz> {
                  ...
                  ButtonWidget(
                    ...
                    onPressed: () async {
                      ...
                      final success = await tesController
                          .submitPostEfficationAnswer(refSoal, jawaban);
                      if (success) {
                        if (tesController.questionIndex.value <
                          ...
                          if (await tesController.updatePostTestScore()) {
                            await treatC.generateTreatment();
                            context.loaderOverlay.hide();
                            Get.toNamed('/post-efikasi-result');
                            // this.gotoResult();
                          }
